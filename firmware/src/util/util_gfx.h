...
#define GFX_WIDTH			ST7735_WIDTH
#define GFX_HEIGHT			ST7735_HEIGHT
 ...
 */
extern void util_gfx_draw_bmp_file(char *filename, uint8_t x, uint16_t y);
 ...
 */
extern void util_gfx_print(char *text);
